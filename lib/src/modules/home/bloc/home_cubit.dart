...
class HomeCubit extends Cubit<HomeState> {
  ...
  void createCard(
    ...
    SharedPreferencesService.saveList(data: _listMap);
  }
  ...
  void handleSelectedLanguage(int languageId) {
    switch (languageId) {
      case 0:
        emit(state.copyWith(languageSelected: AppLocale.en));
        break;
      case 1:
        LocaleSettings.setLocale(AppLocale.br);
        emit(state.copyWith(languageSelected: AppLocale.br));
        break;
    }
  }
